...
> **갱신(v2b):** 이 문서가 "유지"한다고 적은 게이트 기본값(컵 기간 35·선반 길이 5·
> 선반 위치 66)은 이후 책 오라클 보정으로 **min_shelf_days=2·max_shelf_position=90·
> min_cup_days=25** 로 변경됨. 근거: `2026-06-30-find-3c-v2b-gate-tuning-design.md`.

...
MA_REF = 12377
NA_TOL = 0.01
CACHE = Path(str(r91.OUT / "175-partial.json"))
...
def main():
    ...
    for al in ALPHAS:
        ...
        if l1 >= DELTA:
            ...
            c = "**4a/4b** «확실히» «양수»·Δ 미만" if h1 <= DELTA else "**4b** «양수»·Δ 를 «걸침»"
        elif h1 < 0:
            c = "**4a/4b** ⚠️ «확실히» «음수»·Δ 미만" if l1 >= -DELTA else "**4b** «음수»·Δ 를 «걸침»"
        else:
            c = "**5** 🚨 «못 가린다»"

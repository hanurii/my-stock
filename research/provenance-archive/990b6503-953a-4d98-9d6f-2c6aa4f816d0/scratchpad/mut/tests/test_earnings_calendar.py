...
픽스처는 실제 DART 공시 이력(2025-07 ~ 2026-08 조회분)을 그대로 옮긴 것:
  - F&F(383220): 분기마다 예고 → 잠정 → 정기보고서 3단 패턴이 규칙적
  - DN오토모티브(007340): 예고 없이 잠정 → 정기보고서, 2026-08-10 IR개최 안내
  - 신한지주(055550)·테스(095610): 반기보고서 제출 "뒤에" IR개최 안내 —
...
def test_dnauto_ir_near_half_year_deadline():
    ...
    assert r is not None
    assert r["status"] in ("confirmed", "estimated")

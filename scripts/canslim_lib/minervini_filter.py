...
3. **저유동성** (low_liquidity) — 50일 평균 거래대금이 기준(기본 5억원) 미만.
...
# 50일 평균 거래대금 하한(억원). 최초 10억 → 5억 하향(26-08-03, 추천 원장 소급
# 검증: 5억 미만은 +20% 도달 0/98로 죽은 구간이지만 5~10억은 최고 성과 밴드).
# 근거: 스펙 문서 '기준 변경 이력'.
MIN_TURNOVER_EOK_DEFAULT = 5.0

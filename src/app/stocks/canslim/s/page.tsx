        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
          {[
            ...
            },
            {
              ...
              body: "노련한 투자자는 발행수보다 유통 물량(전체 - 대주주·임원 보유)에 주목. 경영진이 자기 회사 주식을 많이 보유하면 애착의 반증 — 대기업 1~3%, 중소기업은 그 이상이 긍정 신호.",
            },
            {
              title: "3. 주식 분할 — 과도하면 천장 신호",
              body: "1대2·2대3은 적정, 1대3·1대5는 공급 급증 위험. 두세 차례 분할 후 본격 상승하는 비율은 18% 채 안 됨. 노련한 프로는 분할 호재에 시장이 고무됐을 때 오히려 매도하고, 공매도 표적은 기관이 이미 대규모로 보유 + 급등 후 하락 시작 종목.",
            },
            {
              title: "4. 자사주 매수 — 강력한 긍정 신호",
              body: "CAN SLIM 충족 기업이 장내에서 지속적으로 자기 주식을 사들이면 (1) 유통 주식 감소 (2) 가까운 매출·순이익 증가 예상 — 두 가지를 동시에 시사. 중소형 성장주가 10%만 매수해도 무척 크다.",
            },
            {
              title: "5. 부채 비율 — 낮을수록 좋다",
              body: "부채 많은 기업의 EPS는 금리 상승 시 급격히 쪼그라든다. 차입의 제1원칙은 '감당할 수 없는 금액은 빌리지 않는 것'. 최근 2~3년 부채 상환한 기업은 이자비용 감소만으로 EPS 증가. 전환사채(CB)는 보통주 전환 시 EPS 희석 주의.",
            },
            {

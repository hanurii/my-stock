...
const ITEMS: GlossaryItem[] = [
  ...
  },
  {
    ...
    definition: "영업으로 번 현금에서 시설투자 등 필수 지출을 뺀 진짜 자유롭게 쓸 수 있는 돈. 환원의 원천.",
  ...
  {
    term: "총 주주환원율 (Total Shareholder Yield)",
    definition: "회사가 1년간 주주에게 돌려준 돈(배당 + 자사주매입)을 시가총액으로 나눈 비율. '진짜 환원되는 비율'.",
    example: "배당수익률 2% + 자사주매입 6% = 총 환원율 8%. 한국 종목은 배당이 주, 미국 종목은 자사주매입이 주. 버핏이 산 2016 애플은 약 8~10%였습니다.",
  },
  {
    term: "자사주매입 (Buyback / Share Repurchase)",
    definition: "회사가 자기 회사 주식을 시장에서 사들이는 행위. 발행주식수가 줄어 1주당 가치가 올라감 = 간접적 주주환원.",
    example: "애플은 2013-2015년 사이 760M주를 사들여 발행주식 12% 감소 — 가만히 있어도 내 지분율 12% 상승.",
  },
  {
    term: "배당수익률 (Dividend Yield)",
    definition: "1주당 연 배당금을 주가로 나눈 비율. 한국식 '월세 같은' 환원의 기본 지표.",
    example: "주가 50,000원 / 연 배당 2,500원 = 5%. 한국 배당주 평균 4~6%, 미국 메가캡 1~3%, 고배당 ETF/REIT 6~10%.",
  },
  {
    term: "배당성향 (Payout Ratio)",
    definition: "당기순이익 중 몇 %를 배당으로 지급하는지. 너무 높으면(>80%) 무리하는 것, 너무 낮으면(<20%) 환원 의지 부족.",
  },
  {

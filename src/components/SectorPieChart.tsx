        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          {activeItem ? (
            ...
            <div className="text-center">
              ...
              <p className="text-lg font-mono text-on-surface font-bold">{formatUSD(totalValue)}</p>
            </div>
          )}
        </div>
      </div>
        ...
        {data.map((item, i) => (
          ...
          >
            ...
            <div className="flex items-center gap-4">
              <span className="text-sm font-mono text-on-surface">{formatUSD(item.value)}</span>
              <span
